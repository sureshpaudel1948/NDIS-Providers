...
<head>
    ...
    <title>Disability Service Providers in Perth, WA | NDIS Providers
        Perth7yu</title>
...
<body>
    <header class="header">
        <a href='#' class="logo">Disability Service Providers <br> NDIS
            Providers Perth</a>

        <nav class="navbar">
            <a href="index.html" style="--i:1;" class="active">Home</a>

            <a href="about.html" style="--i:2;">About Us</a>

            <a href="services.html" style="--i:3;">Our Services</a>

            <a href="#careers" style="--i:4;">Careers</a>

            <a href="group.html" style="--i:4;">Group Activities</a>

            <a href="#contact" style="--i:5;">Contact Us</a>
        </nav>
    </header>
    ...
    <section>
        <div class="careers" id="careers">
            ...
            <h2 class="sign">Career Opportunities:<span> Create an
                    Account</span></h2>
            <form action="insert.php" method="POST">
                <div class=" form">
                    <h3 style="font-weight: bold; font-size: 25px;">Already
                        a registered user? <a href="signIn.html" onclick="ViewProfileAction(event)"> Please sign
                            in</a> </h3>
                    ...
                    <div class="input_field">
                        ...
                        <input type="email" class="input" name="email2" id="email2">
                    </div>
                    <div class="input_field">
                    ...
                    <div class="input_field">
                        ...
                        <input type="text" class="input" name="fname" id="first name">
                    </div>
                    <div class="input_field">
                        <label>Last Name:</label>
                        <input type="text" class="input" name="lname" id="last name">
                    </div>

                    <div class="input_field">
                        <label>Country:</label>
                        <div class="selectbox">
                            <select name="country" style="background-color: transparent; border: 1px solid #F9B75D;">
                    ...
                    <div class="input_field terms">
                        ...
                        <p>I
                            agree to
                            these <a href="#" style="font-size: 14px; color: #d8cdcd">Terms and
                                Conditions</a></p>
                    </div>

                    <div class="input_field">
                        <button type="submit" value="Create Account" class="read" name="create"
    ...
    <section class=" contact" id="contact">
        <div class="contact-text">
            ...
            <h4>Let's get united</h4>
            <p>
                You can contact us through this contact form by
                providing
                your details in order to
                be connected with us. You are all free to send us
                messages
                mentioning your problems and yeah we're always there
                for
                you.</p>
            <div class="contact-list">
                <li> <i class='bx bx-send'></i> :
                    kushal.subedi@dwer.wa.gov.au</li>
    ...
    <div class="footer-text">
        <p> © 2024 caremateforu.com.au &nbsp; &nbsp; All rights
            reserved.</p>
    </div>
